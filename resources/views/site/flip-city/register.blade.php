...
@section('title', 'Regisztráció - ' . config('app.name'))
@section('og_title', 'Regisztráció - ' . config('app.name'))
...
@section('content')
<div class="flipcity flipcity-register">
    <div class="container py-5">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white">
                        <h4 class="mb-0">Regisztráció - Flip-City</h4>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('flip-city.register') }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                <label for="phone" class="col-md-4 col-form-label text-md-right">Telefonszám</label>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6 offset-md-4">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="terms_accepted">
                                            Elfogadom az <a href="#">ÁSZF</a>-et és az <a href="#">adatkezelési tájékoztatót</a>.
                                        </label>
